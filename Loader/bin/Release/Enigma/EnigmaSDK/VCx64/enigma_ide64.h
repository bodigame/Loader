...
// Registration API
__declspec(dllimport) BOOL __stdcall EP_RegSaveKey( const char* Name, const char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegSaveKeyA( const char* Name, const char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegSaveKeyW( const wchar_t* Name, const wchar_t* Key );
...
__declspec(dllimport) int __stdcall EP_RegLoadKeyEx( const char* Name, int* NameLen, const char* Key, int* KeyLen);
__declspec(dllimport) BOOL __stdcall EP_RegCheckKey( const char* Name, const char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckKeyA( const char* Name, const char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckKeyW( const wchar_t* Name, const wchar_t* Key );
__declspec(dllimport) BOOL __stdcall EP_RegDeleteKey();
__declspec(dllimport) BOOL __stdcall EP_RegLoadAndCheckKey();
__declspec(dllimport) BOOL __stdcall EP_RegCheckAndSaveKey( const char* Name, const char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckAndSaveKeyA( const char* Name, const char* Key );
...
__declspec( dllexport ) BOOL __stdcall EP_RegKeyInformation(const char* AName, const char* AKey, PKeyInformation AKeyInfo);
__declspec( dllexport ) BOOL __stdcall EP_RegKeyInformationA(const char* AName, const char* AKey, PKeyInformation AKeyInfo);
__declspec( dllexport ) BOOL __stdcall EP_RegKeyInformationW(const wchar_t* AName, const wchar_t* AKey, PKeyInformation AKeyInfo);
...
__declspec(dllimport) void __stdcall EP_ActivationShowDialog();
...
__declspec(dllimport) int __stdcall EP_TrialClockReversedDays();
...
// Crypt API
__declspec(dllimport) int __stdcall EP_CryptHashBuffer( int Hash, const BYTE* Buffer, int Size, const BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashFileA( int Hash, const char* FileName, const BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashFileW( int Hash, const wchar_t* FileName, const BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashStringA( int Hash, const char* Str, const BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashStringW( int Hash, const wchar_t* Str, const BYTE* Digest);
__declspec(dllimport) void __stdcall EP_CryptEncryptBuffer( const BYTE* Buffer, int Size, const char* Key);
__declspec(dllimport) void __stdcall EP_CryptEncryptBufferEx( const BYTE* InBuffer, const BYTE* OutBuffer, int Size, const BYTE* Key, int KeySize);
__declspec(dllimport) void __stdcall EP_CryptDecryptBuffer( const BYTE* Buffer, int Size, const char* Key);
__declspec(dllimport) void __stdcall EP_CryptDecryptBufferEx( const BYTE* InBuffer, const BYTE* OutBuffer, int Size, const BYTE* Key, int KeySize);
