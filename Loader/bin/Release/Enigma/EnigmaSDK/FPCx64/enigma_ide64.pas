...
function EP_RegLoadKeyEx(Name : pointer; var NameLen : Cardinal; Key : pointer; var KeyLen : Cardinal) : Cardinal;
...
function EP_RegEncryptRegistrationInformation(ABuffer : pointer; var ABufferSize : Cardinal; ARegName : pointer; ARegNameLen : Cardinal; ARegKey : pointer; ARegKeyLen : Cardinal) : Cardinal; stdcall;
function EP_RegDecryptRegistrationInformation(ABuffer : pointer; ABufferSize : Cardinal; ARegName : pointer; var ARegNameLen : Cardinal; ARegKey : pointer; var ARegKeyLen : Cardinal) : Cardinal; stdcall;

{API for online activation}
procedure EP_ActivationShowDialog;
...
function EP_TrialClockReversedDays: Cardinal;
...
function EP_ProtectedStringAsAnsiStringById(ID : integer) : AnsiString;
function EP_ProtectedStringAsAnsiStringByKey(Key : AnsiString) : AnsiString;
function EP_ProtectedStringAsWideStringById(ID : integer) : WideString;
function EP_ProtectedStringAsWideStringByKey(Key : AnsiString) : WideString;
...
function EP_RegLoadKeyEx(Name : pointer; var NameLen : Cardinal; Key : pointer; var KeyLen : Cardinal) : Cardinal; external enigma_api_dll_name name 'EP_RegLoadKeyEx';
...
function EP_RegEncryptRegistrationInformation(ABuffer : pointer; var ABufferSize : Cardinal; ARegName : pointer; ARegNameLen : Cardinal; ARegKey : pointer; ARegKeyLen : Cardinal) : Cardinal; external enigma_api_dll_name name 'EP_RegEncryptRegistrationInformation';
function EP_RegDecryptRegistrationInformation(ABuffer : pointer; ABufferSize : Cardinal; ARegName : pointer; var ARegNameLen : Cardinal; ARegKey : pointer; var ARegKeyLen : Cardinal) : Cardinal; external enigma_api_dll_name name 'EP_RegDecryptRegistrationInformation';

procedure EP_ActivationShowDialog; external enigma_api_dll_name name 'EP_ActivationShowDialog';
...
function EP_TrialClockReversedDays : Cardinal; external enigma_api_dll_name name 'EP_TrialClockReversedDays';
...
procedure EP_Marker(Marker : string); external enigma_api_dll_name name 'EP_Marker';
...
begin
  Result := '';
  len := EP_ProtectedStringByID(ID, nil, 0);
  if len > 0 then
  begin
    SetLength(Result, len);
    EP_ProtectedStringByID(ID, pointer(Result), length(Result));
  end;
end;
...
begin
  Result := '';
  len := EP_ProtectedStringByKey(PAnsiChar(Key), nil, 0);
  if len > 0 then
  begin
    SetLength(Result, len);
    EP_ProtectedStringByKey(PAnsiChar(Key), pointer(Result), length(Result));
  end;
end;
...
begin
  ...
  begin
    ...
    EP_ProtectedStringByID(ID, pointer(Result), len);
  end;
end;
...
begin
  ...
  begin
    SetLength(Result, len shr 1);
    EP_ProtectedStringByKey(PAnsiChar(Key), pointer(Result), len);
  end;
end;
