...
procedure Enigma_Plugin_OnInitEx(AData : pointer; ADataSize : dword);
begin
  // This function is calling when the protected file is being initialized
  // when main program is not initialized yet
...
procedure Enigma_Plugin_OnFinalEx(AData : pointer; ADataSize : dword);
begin
  // This function is calling when the protected file is initilized,
  // main program encrypted and ready for execution
  // AData - pointer to the buffer that contains a data passed by GUI plugin
...
function Enigma_Plugin_OnSaveKey(ARegName : pointer; ARegNameLen : integer; ARegKey : pointer; ARegKeyLen : integer) : boolean;
begin
...
function Enigma_Plugin_OnLoadKey(var ARegName : pointer; var ARegNameLen : integer; var ARegKey : pointer; var ARegKeyLen : integer) : boolean;
begin
...
function Enigma_Plugin_OnDeleteKey : boolean;
begin
